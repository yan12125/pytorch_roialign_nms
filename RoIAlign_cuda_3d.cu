...
at::Tensor ROIAlign_3d_forward_cuda(const at::Tensor& input, const at::Tensor& rois, const double spatial_scale,
                                const int64_t pooled_height, const int64_t pooled_width, const int64_t pooled_depth,
  ...
  at::CheckedFrom c = "ROIAlign_3d_forward_cuda";
    ...
    const bool aligned)
{
  ...
  at::CheckedFrom c = "ROIAlign_3d_backward_cuda";
